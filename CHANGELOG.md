...
- `JsonUtility.CloneDefaultOptions()` — mutable copy of shared default serializer settings for product SDKs (e.g. snake_case naming policy) before constructing a dedicated `JsonUtility`.
